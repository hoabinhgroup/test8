...
function IdLuckyDrawController(n, t, e, a, i, o, s, r, l, c) {
	...
	u.$onInit = function() {
		...
		}), u.idChars.length < 9) for (var t = 0; t < i.checkChars.length; t++) {
	...
	var d = function() {
			...
			u.name = u.names && u.names[s] ? u.names[s] : "", u.namex = u.name.replace("|", "
                        <br/>"), u.selectedIds.push(u.id), i.specialPrizes.indexOf(u.prize.key) == -1 ? u.remainStops = 1 : u.remainStops = 2
		};
...
routesConfig.$inject = ["$stateProvider", "$urlRouterProvider", "$locationProvider", "$modalStateProvider"], appbackgroundDirective.$inject = ["$rootScope"], PresentationController.$inject = ["$rootScope", "$timeout", "defaultSettingService", "navService", "userdataService", "results", "i18nService", "Analytics"], ModController.$inject = ["$rootScope", "$state", "$timeout", "Fullscreen", "devOps", "defaultSettingService", "userdataService", "modalService", "navService", "prizeService", "i18nService", "uxService", "Analytics", "audioService"], MainController.$inject = ["$rootScope", "$http", "$location", "$translate", "paymentService", "modalService", "defaultSettingService", "defaultIdService", "initSettingService", "defaultResultService", "i18nService", "userdataService", "Analytics"], notificationController.$inject = ["$uibModal", "$firebaseObject", "authService", "firebaseRef", "Analytics"], ThemeController.$inject = ["$rootScope", "devOps", "userdataService"], SurveyController.$inject = ["$state", "Analytics"], RegisterController.$inject = ["$state", "$http", "authService", "devOps", "i18nService", "Analytics"], PrizeController.$inject = ["userdataService", "defaultSettingService", "prizeService", "navService", "uxService", "Analytics"], PaymentController.$inject = ["$interval", "$state", "modalService", "userdataService", "i18nService", "paymentService", "devOps", "$compile", "$scope"], PaymentIntroController.$inject = ["$state", "userdataService"], PaymentButtonController.$inject = ["userdataService"], PaypalPaymentController.$inject = ["$sce", "$state", "$http", "authService", "Analytics", "userService", "userdataService", "paymentService", "modalService"], SohaPaymentController.$inject = ["$state", "$http", "authService", "Analytics", "userService", "userdataService", "paymentService", "modalService"], MessageController.$inject = ["userdataService", "Analytics"], LoginController.$inject = ["$state", "authService", "Analytics"], LanguageController.$inject = ["i18nService", "Analytics"], IntroController.$inject = ["modalService"], IdsResultController.$inject = ["$state", "$timeout", "$stateParams", "resultService", "prizeService", "userdataService", "defaultSettingService", "$translate", "userService", "Analytics"], IdController.$inject = ["$state", "navService", "userdataService", "devOps", "Analytics"], ForgotPasswordController.$inject = ["authService", "modalService", "Analytics"], ContactController.$inject = ["$http", "modalService", "devOps", "Analytics"], ButtonController.$inject = ["userdataService", "Analytics"], BackgroundController.$inject = ["$rootScope", "$timeout", "$interval", "userService", "userdataService", "modalService", "Analytics"], AlertController.$inject = ["userService", "$interval"], AccountController.$inject = ["$scope", "modalService", "authService", "userdataService", "devOps", "uxService", "Analytics"], IdLuckyDrawController.$inject = ["$state", "$timeout", "modalService", "defaultSettingService", "devOps", "prizeService", "userService", "uxService", "Analytics", "audioService"], HotKeysController.$inject = ["hotkeys", "modalService", "navService", "Analytics", "audioService"], FooterController.$inject = ["$state", "userService", "modalService", "navService", "uxService", "Analytics", "audioService"], angular.module("app", ["ui.router", "ui.bootstrap", "firebase", "pascalprecht.translate", "angularMoment", "FBAngular", "ngSanitize", "ngCookies", "ngAnimate", "ngFileUpload", "ngSanitize", "ngCsv", "cfp.hotkeys", "angular.filter", "color.picker"]).config(["$qProvider", "$translateProvider", function(n, t) {
	...
	var e = {
		...
		a = function(a, i) {
			...
			e[s] = [];
			for (var r, l, c, u, d, g = Object.keys(n.prizes), m = t.defaultPrizes.length - 1, p = 0; p < g.length; p++) if (r = g[p], u = d = !1, p <= m ? (u = a.enabled_prizes[r] !== !1, o && u && (a.enabled_prizes[r] = !0)) : d = a.enabled_prizes[r] === !0, o || u || d) {
	...
	var l = function(t) {
		...
		u = function(n, e, o, s) {
			...
			if (e && (u.data.action = e), "undefined" != typeof o && (u.data.label = "string" == typeof o ? o : JSON.stringify(o)), "object" == typeof s) for (var d in s) u.data[d] = s[d];
...
angular.module("app").directive("offline", offlineDirective), angular.module("app").directive("appbackground", appbackgroundDirective), angular.module("app").controller("PresentationController", PresentationController), angular.module("app").controller("ModController", ModController), angular.module("app").controller("MainController", MainController), angular.module("app").component("notification", {
	...
	col - xs - 12 ">\n        \n        <h1>\n          <span class="
	event - name " ng-if="
	$ctrl.appState.name !== \'presentation\ '">\n            {{$ctrl.defaultSetting.info.name | translate}}\n          </span>\n          <span class="
	event - name " ng-if="
	$ctrl.appState.name === \'presentation\ ' && $ctrl.setting.info.name " ng-style=" {\'color\ ': $ctrl.setting.colors.name
	}
	">\n            {{$ctrl.setting.info.name}}\n          </span>\n\t\t\t\t</h1>\n        \n\n        <div class="
	header - content ">\n          \n          <span class="
	link - company " ng-if="
	$ctrl.setting.info.company " ng-style="
	$ctrl.ux.style($ctrl.setting.colors.action_msg, 1)">\n            {{$ctrl.setting.info.company}}\n          </span>\n          \n        </div>\n      </div>\n    </div>\n  </div>\n</header>\n\n<div ng-class="
	$ctrl.appState.name === \'presentation\ ' ? \'main-padding\ ' : \'main\ '">\n  <div class="
	container - fluid ">\n    <div class="
	row ">\n      <div class="
	col - xs - 12 ">\n        <section class="
	section section - prize ">\n          <header class="
	section - head " ng-class="
	$ctrl.animClass.setprize " ng-init="
	$ctrl.setPrize(0)">\n            \n            <div class="
	coin ">\n              <img class="
	prize - image " ng-repeat="
	prize in $ctrl.prizes " ng-src=" {
		{
			prize.image
		}
	}
	" ng-show="
	$ctrl.prizeIndex == $index && prize.showimage ">\n            </div>\n            \n          </header>\n\n          \n          <div class="
	section - message ">\n            <h2 ng-style="
	$ctrl.ux.style($ctrl.setting.colors.action_msg, 1)" ng-class="
	$ctrl.animClass.message " ng-switch on="
	$ctrl.state ">\n              <span ng-switch-when="
	ready " class="
	state - ready ">{{$ctrl.setting.messages.start || ($ctrl.defaultSetting.messages.start | translate)}}</span>\n              <span ng-switch-when="
	spin " class="
	state - spin ">{{$ctrl.setting.messages.wait || ($ctrl.defaultSetting.messages.wait | translate)}}</span>\n              <span ng-switch-when="
	reveal "><i class="
	no - text - shadow ion - load - c rotation "></i></span>\n              <span ng-switch-when="
	complete | toconfirm | confirmed | cancel " ng-switch-when-separator=" | " class="
	winner - name " ng-bind-html="
	$ctrl.namex "></span>\n            </h2>\n          </div>\n          \n\n          <div class="
	section - body " ng-class="
	$ctrl.animClass.setprize ">\n            <div class="
	section - body - inner section - body - inner - primary ">\n              <ul class="
	slots ">\n                \n                <li class="
	slot " ng-repeat="
	n in $ctrl.machineSlots " ng-class="\'slot-1of\ ' + $ctrl.slotsCss + \' state-\ ' + $ctrl.state ">\n                  <div class="
	slot - item " ng-repeat="
	i in $ctrl.characters[n]">\n                    <div class="
	slot - number " ng-switch on="
	$ctrl.state ">\n                      <span ng-switch-when="
	ready ">\n                        <img ng-src=" {
		{
			$ctrl.prize.image
	...
	slot - item " ng-if="!$ctrl.characters[n]">\n                    <div class="
	slot - number ">\n                      <span ng-class="
	$ctrl.state !== \'ready\ ' ? \'not-available\ ' : \'available\ '"><img ng-src=" {
		{
			$ctrl.prize.image
		}
	}
	...
	link - prev " ng-mouseover="
	$ctrl.ux.mOver(\'prevnext\ ')" ng-mouseleave="
	$ctrl.ux.mLeave(\'prevnext\ ')" ng-class="
	$ctrl.state !== \'ready\ ' || $ctrl.prizeIndex <= 0 ? \'not-available\ ' : \'available\ '" ng-click="
	$ctrl.setPrize($ctrl.prizeIndex - 1)">\n                <span class="
	keyboard - key prev - key " ng-if="
	$ctrl.ux.hint.prevnext "><span>&leftarrow;</span></span>\n                <i class="
	ion - chevron - left "></i>\n              </a>\n              \n  \n              \n              <span class="
	prize - text ">\n                {{$ctrl.setting.prizes[$ctrl.prize.key] || ($ctrl.defaultSetting.prizes[$ctrl.prize.key] | translate)}}\n              </span>\n              \n  \n              \n              <span class="
	prize - text prize - count ion - person - add " ng-class="
	$ctrl.animClass.prizecount " ng-show="
	$ctrl.prizes[$ctrl.prizeIndex].confirmed ">\n                {{$ctrl.prizes[$ctrl.prizeIndex].confirmed}}\n              </span>\n              \n  \n              \n              <a class="
	link - next " ng-mouseover="
	$ctrl.ux.mOver(\'prevnext\ ')" ng-mouseleave="
	$ctrl.ux.mLeave(\'prevnext\ ')" ng-class="
	$ctrl.state !== \'ready\ ' || $ctrl.prizeIndex >= $ctrl.prizes.length - 1 ? \'not-available\ ' : \'available\ '" ng-click="
	$ctrl.setPrize($ctrl.prizeIndex + 1)">\n                <i class="
	ion - chevron - right "></i>\n                <span class="
	keyboard - key next - key " ng-if="
	$ctrl.ux.hint.prevnext "><span>&rightarrow;</span></span>\n              </a>\n              \n            </div>\n\n            <div ng-switch on="
	$ctrl.state " class="
	section - button ">\n              <div ng-switch-when="
	ready " class="
	state - ready ">\n                <a class="
	btn btn - yellow btn - yellow - secondary " ng-click="
	$ctrl.spin()" ng-mouseover="
	$ctrl.ux.mOver(\'spin\ ')" ng-mouseleave="
	$ctrl.ux.mLeave(\'spin\ ')">\n                  <span class="
	keyboard - key spin - key " ng-if="
	$ctrl.ux.hint.spin "><span>ENTER</span></span>\n                  {{$ctrl.setting.buttons.spin || ($ctrl.defaultSetting.buttons.spin | translate)}}\n                </a>\n                <span ng-if="
	$ctrl.appState.name !== \'customize\ ' && $ctrl.appState.name !== \'presentation\ '">\n                  <a ng-if="
	$ctrl.user.authenticated " ui-sref="
	customize " ng-click="
	$ctrl.analytics.log(\'ui_action\ ', \'Execute\ ', \'Button - Customize\ ')" class="
	btn btn - primary ">\n                    <translate>Customize</translate>\n                  </a>\n                  <a ng-if="!$ctrl.user.authenticated " ui-sref="
	register " ng-click="
	$ctrl.analytics.log(\'ui_action\ ', \'Execute\ ', \'Button - Customize\ ')" class="
	btn btn - primary ">\n                    <translate>Register Now</translate>\n                  </a>\n                </span>\n              </div>\n\n              <div ng-switch-when="
	spin " class="
	state - spin ">\n                <a class="
	btn btn - yellow btn - yellow - secondary - alt " ng-click="
	$ctrl.startstop()" ng-mouseover="
	$ctrl.ux.mOver(\'stop\ ')" ng-mouseleave="
	$ctrl.ux.mLeave(\'stop\ ')">\n                  <span class="
	keyboard - key stop - key " ng-if="
	$ctrl.ux.hint.stop "><span>ENTER</span></span>\n                  {{$ctrl.setting.buttons.stop || ($ctrl.defaultSetting.buttons.stop | translate)}} {{$ctrl.remainStops > 0 ? \'(\ '+$ctrl.remainStops+\')\ ' : \'\ '}}\n                </a>\n              </div>\n\n              <div ng-switch-when="
	complete " class="
	state - complete ">\n                <a class="
	btn btn - yellow btn - yellow - secondary " ng-click="
	$ctrl.save()" ng-mouseover="
	$ctrl.ux.mOver(\'confirm\ ')" ng-mouseleave="
	$ctrl.ux.mLeave(\'confirm\ ')">\n                  <span class="
	keyboard - key confirm - key " ng-if="
	$ctrl.ux.hint.confirm "><span>+</span></span>\n                  {{$ctrl.setting.buttons.confirm || ($ctrl.defaultSetting.buttons.confirm | translate)}}\n                </a>\n                <a class="
	btn btn - primary " ng-click="
	$ctrl.retry()" ng-mouseover="
	$ctrl.ux.mOver(\'confirm\ ')" ng-mouseleave="
	$ctrl.ux.mLeave(\'confirm\ ')">\n                  {{$ctrl.setting.buttons.retry || ($ctrl.defaultSetting.buttons.retry | translate)}}\n                  <span class="
	keyboard - key retry - key " ng-if="
	$ctrl.ux.hint.confirm "><span>−</span></span>\n                </a>\n              </div>\n            </div> \n\n          </div> \n        </section>\n      </div>\n    </div>\n  </div>\n</div> \n\n<app-footer light-off="
	$ctrl.lightOff "></app-footer>\n\n<hot-keys enter="
	$ctrl.startstop()" nextstep="" confirm="
	$ctrl.save()" cancel="
	$ctrl.retry()" prev="
	$ctrl.setPrevPrize()" next="
	$ctrl.setNextPrize()">\n</hot-keys>\n'),n.put( "
	components / modal - account.html ", '<div class="
	modal - header " id="
	modal - Account ">\n\t<h4 class="
	...
	$ctrl.edit = true " ng-hide="
	$ctrl.edit || $ctrl.saving ">{{$ctrl.auth.displayName}}</span>\n\t\t\t\t\t<a href="
	# " class="
	link - edit " ng-click="
	$ctrl.edit = true " ng-hide="
	$ctrl.edit || $ctrl.saving ">\n\t\t\t\t\t\t<i class="
	ion - compose "></i>\n\t\t\t\t\t</a>\n\n\t\t\t\t\t<span class="
	ion - load - a rotation " ng-show="
	$ctrl.saving "></span>\n\t\t\t\t\t\n\t\t\t\t\t<form class="
	form - change - account - info " ng-if="
	$ctrl.edit && !$ctrl.saving " ng-submit="
	$ctrl.updateProfile()">\n\t\t\t\t\t\t<div class="
	input - group ">\n\t\t\t\t\t\t\t<input type="
	text " autofocus class="
	field " id="
	user - company " ng-init="
	$ctrl.ux.focus(\'#user-company\ ')" ng-blur="
	$ctrl.updateProfile()" ng-value="
	$ctrl.auth.displayName " ng-model="
	$ctrl.company " ng-change="
	$ctrl.datachanged = true ">\n\t\t\t\t\t\t\t<div class="
	input - group - btn ">\n\t\t\t\t                <button type="
	submit " class="
	btn btn - primary "><span class="
	ion ion - ios - checkmark - empty "></span></button>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</form>\n\t\t\t\t</li>\n\n\t\t\t\t<li>\n\t\t\t\t\t<strong><translate>Account Type</translate>:</strong> <translate>{{$ctrl.user.status()}}</translate>\n\t\t\t\t\t<a class="
	link - extent " ng-click="
	$ctrl.modals.open(\'Payment\ ')">\n\t\t\t\t\t\t<span ng-switch on="
	$ctrl.user.status()">\n\t\t\t\t\t\t\t<span ng-switch-when="
	Free Account "><translate>Pay to Upgrade</translate></span>\n\t\t\t\t\t\t\t<span ng-switch-when="
	Paid Account "><translate>Pay to Extend</translate></span>\n\t\t\t\t\t\t\t<span ng-switch-when="
	Expired Account "><translate>Pay to Extend</translate></span>\n\t\t\t\t\t\t</span>\n\t\t\t\t\t</a>\n\t\t\t\t</li>\n\n\t\t\t\t<li ng-if="
	$ctrl.member.lastPayment ">\n\t\t\t\t\t<strong><translate>Last Payment</translate>:</strong> {{$ctrl.member.lastPayment | amDateFormat: (\'DateTimeFormat\ ' | translate)}}\n\n\t\t\t\t</li>\n\n\t\t\t\t<li ng-if="
	$ctrl.member.expiration ">\n\t\t\t\t\t<strong><translate>Expiration Date</translate>:</strong> {{$ctrl.member.expiration | amDateFormat: (\'DateTimeFormat\ ' | translate)}}\n\t\t\t\t</li>\n\t\t\t</ul>\n\t\t\t\n\t\t</div>\n\t\t\n\t</div>\n\t\n\n\t<div class="
	modal - entry ">\n\t\t<div class="
	modal - entry - head ">\n\t\t\t<h6><translate>Change Password</translate><span style="
	float: right ">Build {{$ctrl.version}}</span></h6>\n\t\t</div>\n\t\t\n\n\t\t<div class="
	modal - entry - body ">\n\t\t\t<div class="
	...
	form - body ">\n\t\t\t\t\t\t\t<div class="
	form - row ">\n\t\t\t\t\t\t\t\t<label for="
	field - new - password " class="
	form - label "><translate>Current password</translate></label>\n\n\t\t\t\t\t\t\t\t<input type="
	password " class="
	field " name="
	field - password " id="
	field - password " value="" placeholder=" * * * * * * " required ng-model="
	$ctrl.password ">\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\n\n\t\t\t\t\t\t\t<div class="
	form - row ">\n\t\t\t\t\t\t\t\t<label for="
	field - new - password " class="
	form - label "><translate>New password</translate></label>\n\n\t\t\t\t\t\t\t\t<input type="
	password " class="
	field " name="
	field - new - password " id="
	field - new - password " value="" placeholder=" * * * * * * " required ng-model="
	$ctrl.newPassword ">\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\n\n\t\t\t\t\t\t\t<div class="
	form - row ">\n\t\t\t\t\t\t\t\t<label for="
	field - re - enter " class="
	form - label "><translate>Re-enter</translate></label>\n\n\t\t\t\t\t\t\t\t<input type="
	password " class="
	field " name="
	field - re - enter " id="
	field - re - enter " value="" placeholder=" * * * * * * " required ng-model="
	$ctrl.rePassword ">\n\n\t\t\t\t\t\t\t\t<p class="
	form - success ">{{$ctrl.success}}</p>\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t<p class="
	form - error ">{{$ctrl.error}}</p>\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\n\n\t\t\t\t\t\t<div class="
	form - actions ">\n\t\t\t\t\t\t\t<button type="
	submit " class="
	btn - alt btn - yellow - alt form - btn ">\n\t\t\t\t\t\t\t\t<translate ng-hide="
	$ctrl.loading ">Change password</translate>\n\t\t            <span class="
	ion - load - a rotation " ng-show="
	$ctrl.loading "></span>\n\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\n\t\t\t\t\t</fieldset>\n\t\t\t\t</form>\n\t\t\t</div>\n\t\t\t\n\t\t</div>\n\t\t\n\t</div>\n\t\n</div>\n\n'),n.put( "
	components / modal - alert.html ", '<div class="
	modal - header " id="
	modal - Alert ">\n  <h4 class="
	modal - title ">\n    <i class="
	...
	components / modal - background.html ", '<div class="
	modal - header " id="
	modal - Background ">\n  <h4 class="
	modal - title ">\n\t\t\t<i class="
	...
	modal - body ">\n  <ul class="
	list - backgrounds ">\n    <li>\n      <div>\n        <img ng-if="
	$ctrl.info.background " ng-src=" {
		{
			$ctrl.info.background
		}
	}
	">\n      </div>\n      <div class="
	tools ">\n        <a ng-if="!$ctrl.user.authenticated " ng-click="
	$ctrl.modals.isAuthenticated(\'login\ ', \'Background\ ')">\n          <span class="
	ion - plus "></span>\n          <span><translate>Upload New Background</translate></span>\n        </a>\n        <a ng-if="
	$ctrl.user.authenticated && !$ctrl.editing.infobackground " ngf-select="
	$ctrl.uploadBackground($file)" ngf-accept="\'image/*\ '" ngf-pattern="\'image/*\ '" ngf-resize=" {
		width: 3100
	}
	">\n          <span class="
	ion - plus "></span>\n          <span><translate>Upload New Background</translate></span>\n        </a>\n        <a href="
	# " ng-if="
	$ctrl.editing.infobackground ">\n          <span class="
	ion - load - a rotation "></span>\n          <span><translate>Uploading...</translate></span>\n          <span>{{$ctrl.uploadProgress}}%</span>\n        </a>\n        <a ng-if="
	$ctrl.info.background && !$ctrl.editing.infobackground " ng-click="
	$ctrl.removeBackground()">\n          <span class="
	ion - minus "></span>\n          <span><translate>Remove Background</translate></span>\n        </a>\n      </div>\n    </li>\n  </ul>\n  \n</div>\n\n'),n.put( "
	components / modal - button.html ", '<div class="
	modal - header " id="
	modal - Button ">\n  <h4 class="
	...
	form - row ">\n            <label for="
	field - text1 " class="
	form - label "><translate>Spin</translate></label>\n\n            <input type="
	text " autofocus class="
	field " name="
	field - text1 " id="
	field - text1 " ng-attr-placeholder=" {
		{\'Spin\ ' | translate
		}
	}
	" ng-model="
	$ctrl.buttons.spin " ng-change="
	$ctrl.datachanged = true ">\n          </div>\n          \n\n          <div class="
	form - row ">\n            <label for="
	field - text2 " class="
	form - label "><translate>Stop</translate></label>\n\n            <input type="
	text " class="
	field " name="
	field - text2 " id="
	field - text2 " ng-attr-placeholder=" {
		{\'Stop\ ' | translate
		}
	}
	" ng-model="
	$ctrl.buttons.stop " ng-change="
	$ctrl.datachanged = true ">\n          </div>\n          \n\n          <div class="
	form - row ">\n            <label for="
	field - text2 " class="
	form - label "><translate>Confirm</translate></label>\n\n            <input type="
	text " class="
	field " name="
	field - text2 " id="
	field - text3 " ng-attr-placeholder=" {
		{\'Confirm\ ' | translate
		}
	}
	" ng-model="
	$ctrl.buttons.confirm " ng-change="
	$ctrl.datachanged = true ">\n          </div>\n          \n\n          <div class="
	form - row ">\n            <label for="
	field - text2 " class="
	form - label "><translate>Retry</translate></label>\n\n            <input type="
	text " class="
	field " name="
	field - text2 " id="
	field - text4 " ng-attr-placeholder=" {
		{\'Retry\ ' | translate
		}
	}
	" ng-model="
	$ctrl.buttons.retry " ng-change="
	$ctrl.datachanged = true ">\n          </div>\n          \n        </div>\n        \n\n        <div class="
	form - actions ">\n          <button type="
	button " class="
	btn - alt btn - grey " ng-click="
	$ctrl.reset()"><translate>Reset Default</translate></button>\n\n          <button type="
	button " class="
	btn - alt btn - grey " ng-click="
	$ctrl.dismiss()"><translate>Cancel</translate></button>\n\n          <button type="
	submit " class="
	btn - alt btn - yellow - alt form - btn ">\n            <translate ng-hide="
	$ctrl.loading ">Save</translate>\n            <span class="
	ion - load - a rotation " ng-show="
	$ctrl.loading "></span>\n          </button>\n        </div>\n        \n      </fieldset>\n    </form>\n  </div>\n  \n</div>\n\n'),n.put( "
	components / modal - contact.html ", '<div class="
	modal - header " id="
	modal - Contact ">\n  <h4 class="
	...
	ion - close "></i>\n  </button>\n</div>\n\n\n<div class="
	modal - body ">\n  <div class="
	form - login - register form - contact ">\n    <form ng-submit="
	$ctrl.submit()">\n      <fieldset ng-disabled="
	$ctrl.loading ">\n        <div class="
	form - body ">\n          <div class="
	form - row ">\n            <label for="
	field - name " class="
	form - label "><translate>Contact Name</translate></label>\n\n            <div class="
	form - controls ">\n              <i class="
	ion - person "></i>\n\n              <input type="
	text " autofocus class="
	field " name="
	field - name " id="
	field - name " value="" ng-model="
	$ctrl.data.contact_name " required>\n            </div>\n            \n          </div>\n          \n\n          <div class="
	form - row ">\n            <label for="
	field - email " class="
	form - label "><translate>Email</translate></label>\n\n            <div class="
	form - controls ">\n              <i class="
	ion - email "></i>\n\n              <input type="
	email " class="
	field " name="
	field - email " id="
	field - email " value="" ng-model="
	$ctrl.data.contact_email " required>\n            </div>\n            \n          </div>\n          \n\n          <div class="
	form - row ">\n            <label for="
	field - inquiry " class="
	form - label form - label - top "><translate>Inquiry</translate></label>\n\n            <div class="
	form - controls ">\n              <textarea class="
	textarea " name="
	field - inquiry " id="
	field - inquiry " ng-model="
	$ctrl.data.contact_message " required></textarea>\n            </div>\n            \n          </div>\n          \n        </div>\n        \n\n        <div class="
	form - actions ">\n          <button type="
	submit " class="
	btn btn - yellow form - btn ">\n            <translate ng-hide="
	$ctrl.loading ">Submit</translate>\n            <span class="
	ion - load - a rotation " ng-show="
	$ctrl.loading "></span>\n          </button>\n        </div>\n        \n\n      </fieldset>\n    </form>\n  </div>\n  \n</div>\n\n'),n.put( "
	components / modal - forgot - password.html ", '<div class="
	modal - header " id="
	modal - ForgotPassword ">\n  <h4 class="
	modal - title ">\n\t\t<i class="
	ion - android - person "></i>\n\t\t<translate>Reset Password</translate>\n\t</h4>\n  \n\n  <button type="
	button " class="
	close " ng-click="
	$ctrl.dismiss(\'\ ')">\n    <i class="
	ion - close "></i>\n  </button>\n</div>\n\n<div class="
	modal - body ">\n  <div class="
	form - login - register form - login ">\n    <form ng-submit="
	$ctrl.forgotPassword()">\n      <fieldset ng-disabled="
	$ctrl.loading ">\n        <div class="
	form - body ">\n          <div class="
	...
	field " name="
	field - email " id="
	field - email " value="" placeholder=" {
		{\'abcd@gmail.com\ ' | translate
		}
	}
	" autocomplete="
	off " required ng-model="
	$ctrl.email ">\n            </div>\n            \n            <p class="
	form - error ">{{$ctrl.error}}</p>\n          </div>\n          \n        </div>\n        \n\n        <div class="
	form - actions ">\n          <button type="
	submit " class="
	btn btn - yellow form - btn ">\n            <translate ng-hide="
	$ctrl.loading ">Send email</translate>\n            <span class="
	ion - load - a rotation " ng-show="
	$ctrl.loading "></span>\n          </button>\n        </div>\n        \n      </fieldset>\n    </form>\n  </div>\n  \n\n  <a ui-sref="
	register " class="
	link -
	return " ng-click="
	$ctrl.analytics.log(\'ui_action\ ', \'Execute\ ', \'Link - Register\ ')">\n    <i class="
	ion - arrow - right - b "></i>\n    <span>\n      <translate>Return to Login form</translate>.\n\t\t</span>\n  </a>\n</div>\n\n'),n.put( "
	components / modal - id.html ", '<div class="
	modal - header " id="
	modal - Id ">\n  <h4 class="
	...
	$ctrl.save(0)">\n      <fieldset ng-disabled="
	$ctrl.loading ">\n        <div class="
	form - head ">\n          <img src=" / images / temp / numbers.svg " alt="" width="
	32 " height="
	15 ">\n\n          <strong><translate>Your Drawing IDs</translate></strong>\n\n          \n        </div>\n        \n\n        <div class="
	form - body ">\n          <div class="
	form - row ">\n            <div class="
	id - generator ">\n              <label for="
	field - generate - id " class="
	form - label "><translate>Or Auto Generate ID</translate>:</label>\n\n              <input type="
	text " class="
	field " name="
	field - generate - id " id="
	field - generate - id " ng-value=" {
		{
			$ctrl.start
		}
	}
	...
	text " class="
	field " name="
	field - generate - id - 2 " id="
	field - generate - id - 2 " value=" {
		{
			$ctrl.end
		}
	}
	...
	">\n        <div class="
	tab - pane - inner " ng-include="\'templates/tab-about.html\ ' | translate "></div>\n      </uib-tab>\n      <uib-tab index="
	1 " heading=" {
		{\'FAQ\ ' | translate
		}
	}
	">\n        <div class="
	tab - pane - inner " ng-include="\'templates/tab-faq.html\ ' | translate "></div>\n      </uib-tab>\n      <uib-tab index="
	2 " heading=" {
		{\'Term of Service\ ' | translate
		}
	}
	">\n        <div class="
	tab - pane - inner " ng-include="\'templates/tab-term.html\ ' | translate "></div>\n      </uib-tab>\n      <uib-tab index="
	3 " heading=" {
		{\'Privacy Policy\ ' | translate
		}
	}
	">\n        <div class="
	tab - pane - inner " ng-include="\'templates/tab-policy.html\ ' | translate "></div>\n      </uib-tab>\n      <uib-tab index="
	4 " heading=" {
		{\'Contact and Support\ ' | translate
		}
	}
	" select="
	$ctrl.modals.open(\'Contact\ ')">\n        <div class="
	tab - pane - inner " ng-include="\'templates/tab-contact.html\ ' | translate "></div>\n      </uib-tab>\n    </uib-tabset>\n  </div>\n</div>\n\n'),n.put( "
	components / modal - language.html ", '<div class="
	modal - header " id="
	modal - Language ">\n  <h4 class="
	modal - title ">\n\t\t\t<i class="
	...
	ion - close "></i>\n  </button>\n</div>\n\n\n<div class="
	modal - body ">\n  <ul class="
	list - languages ">\n    <li ng-repeat=" (key, language) in $ctrl.languages " ng-class=" {
		current: $ctrl.language == key
	}
	">\n      <a href="" ng-click="
	$ctrl.changeLanguage(key)">\n        <img ng-src=" {
		{
			language.flag
		}
	}
	">\n        <span>{{language.name}}</span>\n      </a>\n    </li>\n  </ul>\n  \n</div>\n\n'),n.put( "
	components / modal - login.html ", '<div class="
	modal - header " id="
	modal - Login ">\n  <h4 class="
	modal - title ">\n\t\t<i class="
	...
	field " name="
	field - email " id="
	field - email " value="" ng-attr-placeholder=" {
		{\'abcd@gmail.com\
                                                ' | translate
		}
	}
	" autocomplete="
	off " required autofocus ng-model="
	$ctrl.email ">\n            </div>\n            \n          </div>\n          \n\n          <div class="
	form - row ">\n            <label for="
	field - password " class="
	form - label "><translate>Password</translate></label>\n\n            <div class="
	form - controls ">\n              <i class="
	ion - android - lock "></i>\n\n              <input type="
	password " class="
	field field - password " name="
	field - password " id="
	field - password " value="" placeholder=" * * * * * * * " autocomplete="
	off " required ng-model="
	$ctrl.password ">\n\n              <span class="
	form - hint ">\n  \t\t\t\t\t\t\t\t\t\t\t<a ui-sref="
	forgotPassword " ng-click="
	$ctrl.analytics.log(\'ui_action\ ', \'Execute\ ', \'Link - Forgot Password\ ')"><translate>Forgot password</translate>?</a>\n  \t\t\t\t\t\t\t\t\t\t</span>\n            </div>\n            \n\n            <p class="
	form - error ">{{$ctrl.error}}</p>\n          </div>\n          \n        </div>\n        \n\n        <div class="
	form - actions ">\n          <button type="
	submit " class="
	btn btn - yellow form - btn ">\n            <translate ng-hide="
	$ctrl.loading ">Login</translate>\n            <span class="
	ion - load - a rotation " ng-show="
	$ctrl.loading "></span>\n          </button>\n        </div>\n        \n      </fieldset>\n    </form>\n  </div>\n  \n\n  <a ui-sref="
	register " class="
	link -
	...
	field - text1 " class="
	form - label ">
                                                                                <translate>Press the Spin button to start</translate>
                                                                            </label>\n\n
                                                                            <input type="
	text " autofocus class="
	field " name="
	field - text1 " id="
	field - text1 " ng-attr-placeholder=" {
		{\'Press the Spin button to start\' | translate}}" ng-model="$ctrl.messages.start" ng-change="$ctrl.datachanged = true">\n </div>\n \n\n
                                                                        <div class="form-row">\n
                                                                            <label for="field-text2" class="form-label">
                                                                                <translate>Winner is coming...</translate>
                                                                            </label>\n\n
                                                                    ...
                                                                    <div class="form-actions">\n
                                                                        <button type="button" class="btn-alt btn-grey" ng-click="$ctrl.reset()">
                                                                            <translate>Reset Default</translate>
                                                                        </button>\n\n
                                                                        <button type="button" class="btn-alt btn-grey" ng-click="$ctrl.dismiss()">
                                                                            <translate>Cancel</translate>
                                                                        </button>\n\n
                                                                        <button type="submit" class="btn-alt btn-yellow-alt form-btn">\n
                                                                            <translate ng-hide="$ctrl.loading">Save</translate>\n <span class="ion-load-a rotation" ng-show="$ctrl.loading"></span>\n </button>\n </div>\n \n </fieldset>\n </form>\n </div>\n \n</div>\n\n'), n.put("components/modal-notify.html", '
                                                    <div class="modal-header" id="modal-Notify">\n
                                                    ...
                                                    <div class="modal-body">\n
                                                        <div class="subscription subscription-complete">\n
                                                            ...
                                                            <p>\n
                                                                <translate>Your subscription</translate>: <strong>{{$ctrl.notification.$value  | amDateFormat:(\'DateTimeFormat\' | translate)}}</strong>
                                                                <br>\n
                                                                <translate>Thanks for being awesome with Lucky Draw</translate>
                                                                <br>\n
                                                                <translate>Now you’ll return to edit your custom Photos/ IDs</translate>
                                                                <br>\n </p>\n\n <a class="btn-alt btn-orange" ng-click="$ctrl.close()">Ok</a>\n </div>\n \n</div>\n\n'), n.put("components/modal-payment.html", '
                                                    <div class="modal-header" id="modal-Payment">\n
                                                            ...
                                                            <form ng-submit="$ctrl.save()" ng-init="$ctrl.ux.focus(\'#field-x-prize\')">\n
                                                                <fieldset ng-disabled="$ctrl.loading">\n
                                                                    ...
                                                                    <div class="form-actions">\n
                                                                        ...
                                                                        <button type="button" class="btn-alt btn-grey" ng-click="$ctrl.doDismiss()">
                                                                            <translate>Cancel</translate>
                                                                        </button>\n\n
                                                                        <button type="submit" class="btn-alt btn-yellow-alt form-btn">\n
                                                                            <translate ng-hide="$ctrl.loading">Save</translate>\n <span class="ion-load-a rotation" ng-show="$ctrl.loading"></span>\n </button>\n </div>\n \n </fieldset>\n </form>\n </div>\n \n</div>\n\n'), n.put("components/modal-register.html", '
                                                    <div class="modal-header" id="modal-Register">\n
                                                            ...
                                                            <form ng-submit="$ctrl.register()">\n
                                                                <fieldset ng-disabled="$ctrl.loading">\n
                                                                    <div class="form-body">\n
                                                                        <div class="form-row">\n
                                                                            <p>
                                                                                <translate>You can create your own lucky drawing list after registration</translate>
                                                                            </p>\n </div>\n
                                                                        <div class="form-row">\n
                                                                            <label for="field-company" class="form-label">
                                                                        ...
                                                                        <div class="form-row">\n
                                                                            <label for="field-phone" class="form-label">
                                                                    ...
                                                                    <div class="form-actions">\n
                                                                        <button type="submit" class="btn btn-yellow form-btn">\n
                                                                            <translate ng-hide="$ctrl.loading">Register</translate>\n <span class="ion-load-a rotation" ng-show="$ctrl.loading"></span>\n </button>\n </div>\n \n </fieldset>\n </form>\n </div>\n \n\n <a ui-sref="login" class="link-return" ng-click="$ctrl.analytics.log(\'ui_action\', \'Execute\', \'Link - Login\')">\n    <i class="ion-arrow-right-b"></i>\n    <span>\n\t\t\t\t\t\t\t<translate>Already have an account?</translate> <strong><translate>Login</translate>.</strong>\n\t\t\t\t\t\t</span>\n  </a>\n</div>\n\n'), n.put("components/modal-survey.html", '
                                                    <div class="modal-header" id="modal-Login">\n
                                                        <h4 class="modal-title">\n\t\t<translate>Hi there, what are you doing with Luckydraw.live?</translate>\n\t</h4>\n \n\n \n</div>\n\n
                                                    <div class="modal-body">\n
                                                        <div class="form-login-register form-login">\n
                                                            <div>\n <i class="ion-ios-list"></i>\n
                                                                <a ng-click="$ctrl.select(\'Planning Event\')">
                                                                    <translate>I\'m planning a lucky draw event</translate>
                                                                </a>\n
                                                                <hr>\n </div>\n
                                                            <div>\n <i class="ion-social-usd"></i>\n
                                                                <a ng-click="$ctrl.select(\'Play Game\')">
                                                                    <translate>I want to play online lucky draw</translate>
                                                                </a>\n
                                                                <hr>\n </div>\n
                                                            <div>\n <i class="ion-calculator"></i>\n
                                                                <a ng-click="$ctrl.select(\'Random Number\')">
                                                                    <translate>I need some random numbers</translate>
                                                                </a>\n </div>\n </div>\n \n</div>\n\n'), n.put("components/modal-theme.html", '
                                                    <div class="modal-header" id="modal-Theme">\n
                                                    ...
                                                    <div class="modal-body">\n
                                                        ...
                                                        <div class="cleafix"></div>\n</div>\n\n'), n.put("templates/main.html", '
                                                    <id-lucky-draw data="$ctrl.data" setting="$ctrl.setting" results="$ctrl.results" is-limited="$ctrl.isLimited(r)"></id-lucky-draw>\n'), n.put("templates/mod.html", '
                                                    <header class="header" ng-if="!$ctrl.lockUI">\n
                                                        <div class="container-fluid">\n
                                                            <div class="row">\n \n
                                                    ...
                                                    <hot-keys enter="" nextstep="$ctrl.goPresentation()" confirm="" cancel="" prev="$ctrl.setPrevPrize()" next="$ctrl.setNextPrize()">\n</hot-keys>'), n.put("templates/presentation.html", '
                                                    <id-lucky-draw ng-if="!$ctrl.lockUI" data="$ctrl.data" setting="$ctrl.setting" results="$ctrl.results" is-limited="$ctrl.isLimited(r)"></id-lucky-draw>\n'), n.put("templates/tab-about.html", '
                                                    <ol class="tab-items">\n
                                                        <li class="tab-item">\n
                                                        ...
                                                        <li class="tab-item">\n
                                                            ...
                                                            <ul>\n
                                                                ...
                                                                <li>Email: hi@luckydraw.live</li>\n </ul>\n </li>\n</ol>\n'), n.put("templates/tab-contact.html", '
                                                    <ol class="tab-items">\n</ol>\n\n'), n.put("templates/tab-faq.html", '
                                                    <ol class="tab-items">\n
                                                        <li class="tab-item">\n
                                                    ...
                                                    <h6>\n\t\t\t\t\t\t\t<translate>Usage Days</translate>\n              <br>\n              <em><translate>Service Price Guide</translate></em>\n\t\t\t\t\t\t</h6>'), n.put("templates/payment-form/paypal.html", '
                                                    <form ng-attr-action="{{$ctrl.paypal.action}}" method="post" target="_top" ng-submit="$ctrl.submit()">\n \n \n\n
                                                        <div class="form-body">\n
                                                        ...
                                                        <div class="form-body">\n
                                                            <div class="form-alert">\n
                                                                <div class="subscription">\n \n
                                                                    ...
                                                                    <br>\n\n <img src="/images/temp/cards.jpg" height="21" width="261" alt="">\n\n
                                                                    <br>
                                                                    <br>\n {{$ctrl.paymentGuide | translate}}\n\n </div>\n \n </div>\n \n </div>\n \n \n </form>\n'), n.put("templates/vi/tab-about.html", '
                                                    <ol class="tab-items">\n
                                                        <li class="tab-item">\n
                                                        ...
                                                        <li class="tab-item">\n
                                                            ...
                                                            <ul>\n
                                                                ...
                                                                <li>Email: hi@luckydraw.live</li>\n </ul>\n </li>\n</ol>\n'), n.put("templates/vi/tab-faq.html", '
                                                    <ol class="tab-items">\n
                                                        <li class="tab-item">\n
	...
	}]), angular.module("app").config(routesConfig); //# sourceMappingURL=../maps/scripts/app-287a065b4e.js.map