...
function PaymentController(n,t,e,a,i,o,s,r,l){var c=this;c.$onInit=function(){c.modals=e,c.user=a,c.dismissCountDown=null;var n=i.getLang();o.local[n]||(n=s.runtime.language);var t=o.local[n]+"-payment-form",u="<"+t+"></"+t+">",d=l.$new(!0,l);$("div#payment-form").html(r(u)(d))}}
